 ...
 * @method position            setLibelletypemateriel() Sets the current record's "libelletypemateriel" value
 * @method position            setDemandeMateriels()    Sets the current record's "DemandeMateriels" collection
 * 
 * @package    ash
 * @subpackage model
