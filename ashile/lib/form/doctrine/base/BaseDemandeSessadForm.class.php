...
/**
 * DemandeSessad form base class.
 *
 * @method DemandeSessad getObject() Returns the current form's model object
 *
 * @package    ash
 * @subpackage form
 ...
 */
abstract class BaseDemandeSessadForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'date_demande_sessad' => new sfWidgetFormDate(),
    ...
    $this->setValidators(array(
      ...
      'date_demande_sessad' => new sfValidatorDate(array('required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'DemandeSessad', 'column' => array('mdph_id')))
    );

    $this->widgetSchema->setNameFormat('demande_sessad[%s]');
