...
/**
 * DemandeTransport form base class.
 *
 * @method DemandeTransport getObject() Returns the current form's model object
 *
 * @package    ash
 * @subpackage form
 ...
 */
abstract class BaseDemandeTransportForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'date_demande_transport' => new sfWidgetFormDate(),
    ...
    $this->setValidators(array(
      ...
      'date_demande_transport' => new sfValidatorDate(array('required' => false)),
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'DemandeTransport', 'column' => array('mdph_id')))
    );

    $this->widgetSchema->setNameFormat('demande_transport[%s]');
