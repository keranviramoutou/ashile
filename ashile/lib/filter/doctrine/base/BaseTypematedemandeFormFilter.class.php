...
/**
 * Typematedemande filter form base class.
 *
 * @package    ash
 * @subpackage filter
 ...
 */
abstract class BaseTypematedemandeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('typematedemande_filters[%s]');
