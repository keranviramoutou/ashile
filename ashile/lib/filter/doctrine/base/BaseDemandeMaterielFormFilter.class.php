...
/**
 * DemandeMateriel filter form base class.
 *
 * @package    ash
 * @subpackage filter
 ...
 */
abstract class BaseDemandeMaterielFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'date_demande_materiel' => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
    ...
    $this->setValidators(array(
      ...
      'date_demande_materiel' => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDateTime(array('required' => false)))),
    ...
    $this->widgetSchema->setNameFormat('demande_materiel_filters[%s]');
