...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/html/data/appli/ashile/log/academie_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/html/data/appli/ashile/cache/academie/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/html/data/appli/ashile/apps/academie/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/html/data/appli/ashile/cache/academie/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/html/data/appli/ashile/apps/academie/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'smtp.ac-reunion.fr',
      'port' => 25,
      'encryption' => NULL,
      'username' => 'acad.ash@ac-reunion.fr',
      'password' => 'ash974',
    ),
  ),
))));
