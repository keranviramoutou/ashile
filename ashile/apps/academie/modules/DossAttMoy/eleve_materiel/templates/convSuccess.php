...
<?php echo '<br><br><br><br>'; ?>
	...
	<?php	foreach($materiels as $materiel) { ?>
			  <?php if(strlen($materiel['prixachat']) > 0){
			  $prix = $materiel['prixachat'] ;
			  }else{
			  $prix ='<font  color="red">Pas de prix !</font>';
			  } ?>
			...
			<?php	echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='checkbox' name='groupMateriel' value='".$materiel['materiel_id']."'>".$materiel['typemateriel'].'&nbsp;- cat :&nbsp;'.$materiel['libellecatmateriel'].'&nbsp; n°: &nbsp;'. $num_mat.
				'&nbsp;-&nbsp;Prêt du &nbsp;'.format_date($materiel['datedebut'],'dd/MM/yyyy').'&nbsp;au&nbsp;'.format_date($materiel['datefin'],'dd/MM/yyyy').'&nbsp; Prix d\'achat :&nbsp;'.$prix.'</small><br>'; ?>
		<?php	} 	?>
