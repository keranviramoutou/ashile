...
<br><h4><?php echo 'Historique des position des contrats pour :&nbsp;'.$PosAvs[0]['avsnom'].'&nbsp;'.$PosAvs[0]['avsprenom'].'&nbsp;('.$PosAvs[0]['avs_id'].'&nbsp;)&nbsp;' ?></h4> <br>
...
<?php foreach($PosAvs as $PosAvss): ?>
    <tr>
	   ...
	   ?>
		     ...
		     <td><?php echo $PosAvss['libelletypepositionavs'] ?></td>
