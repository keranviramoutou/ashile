    ...
    <tbody>
        <?php foreach ($eleves as $eleve): ?>
           <tr onClick="window.location.href='<?php echo link_to_frontend('', array('module' => 'eleve', 'action' => 'edit', 'id' => $eleve['eleveId'],  'academie' => 'true' )) ?>'" style="cursor: pointer" >
                ...
                <td><?php echo link_to('Créer', 'orientation/new?eleve_id=' . $eleve['eleveId'] )  ?> <a href="<?php echo url_for('orientation/edit?id=' . $eleve['orientationId'].'&secteur_id=' . $eleve['secteur_id'].'&eleve_id=' . $eleve['eleveId'] ) ?>"><?php echo 'Modifier'  ?></td>
                <td><a href="<?php echo link_to_frontend('', array('module' => 'eleve', 'action' => 'edit', 'id' => $eleve['eleveId'],  'academie' => 'true')) ?>">
			<?php echo $eleve['nom'].'  '.$eleve['prenom']?></a><?php echo '&nbsp;- INE : &nbsp;'.$eleve['eleveId'] ?></td>
