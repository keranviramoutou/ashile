...
<script type="text/javascript">
   $j(document).ready(function() {
	...
	<h3>Gestion des Personnels > Gestion des affectations > Liste des élèves accompagnés à ce jour sur le secteur de : <?php echo $eleve_avss[0]['secteur'] ?></h3> 
			  ...
			  <?php
			   ...
			   ?>
				<tr>
					...
					<a href="<?php echo url_for('eleve_avs/edit?id='.$eleve_avs['id'].'&eleve_id=' . $eleve_avs['eleve_id'] . '&avs_id=' . $eleve_avs['avs_id'].'&secteur_id=' . $eleve_avs['secteur_id']); ?>"><?php echo 'Modifier'  ?>
