...
<div id="position_avs">
<h2>Edition Position pour le contrat </h2>
<!--------------------------------------------------------->
...
<?php echo '<p>Type du contrat :&nbsp;<strong>'. $avs[0]['typecontrat'].'</strong>&nbsp;Quotité horaire hebdo. :&nbsp;<strong>'.$avs[0]['temps_hebdo'].'&nbsp;Heure(s)</strong>'; ?>
