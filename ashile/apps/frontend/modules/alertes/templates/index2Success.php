...
<h1>Liste des Sessad ou Transports en attente de moyen</h1>
<table cellpadding="0" cellspacing="0" border="0" class="display" id="dataTable">
  ...
  <?php  foreach ($eleves as $demande):	?>	
		...
		<?php $this->avs_alerte = Doctrine_Core::getTable('DemandeAvs')->DemandeAvsencour($demande['eleve_id']); ?>
	
     			<td><?php echo $demande['mdph_id']?></td>
				<td class="center"><?php echo format_date($demande['datedebutnotif'],'dd/MM/yyyy').'&nbsp;'.format_date($demande['datefinnotif'],'dd/MM/yyyy') ?></td>
